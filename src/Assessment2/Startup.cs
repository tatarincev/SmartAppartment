...
using Assessment2.Services.Azure;
using AutoMapper;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1",
                    new OpenApiInfo
                    {
                        Title = "Super Extra Relevant Apartment Data Search API. 2st Technical Assessment",
                        Version = "v1"
                    }
                );
            ...
            services.AddTransient<ISearchIndexer, AzureSearchIndexer>();
